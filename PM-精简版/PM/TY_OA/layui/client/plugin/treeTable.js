...
layui.define(['laytpl', 'form', 'util'], function (exports) {
    ...
    $(document).on('click', '.ew-tree-table-cell>.layui-table-grid-down', function (e) {
        ...
        $cell.children('.ew-tree-table-cell-content').html("<pre>" + $cell.children('.ew-tree-table-cell-content').html() + "</pre>");
    ...
    function hideAllTdTips() {
        if ($(".ew-tree-tips-open>.ew-tree-table-cell-content").length > 0)
            $(".ew-tree-tips-open>.ew-tree-table-cell-content").html($(".ew-tree-tips-open>.ew-tree-table-cell-content").html().replace("<pre>", "").replace("</pre>", ""));
        ...
        //$('.ew-tree-table-cell>.ew-tree-table-cell-content').html($('.ew-tree-table-cell>.ew-tree-table-cell-content').html().replace("<pre>", "").replace("</pre>", ""));
    }
    ...
    $('head').append([
        ...
        '.ew-tree-table .ew-tree-pack > .layui-icon, .ew-tree-table .ew-tree-pack > .fa, .ew-tree-table .ew-tree-pack > .ew-tree-icon {',
        '    margin-right: 5px;',
        '}',
