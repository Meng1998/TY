...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        layui.define('jquery', function (exports) {
            var $ = layui.jquery;
            layui.link(layui.cache.base + 'lib/tagsInput/tagsInput.css');
    ...
    $.fn.addTag = function (value, options) {
        ...
        this.each(function () {
            ...
            var indexlist = $(this).attr("index").split(delimiter[id]);
            if (tagslist[0] == '') {
                tagslist = new Array();
                indexlist = new Array();
            }
            ...
            if (value != '' && skipTag != true) {
                ...
                $.fn.tagsInput.updateTagsField(this, tagslist, indexlist);
    ...
    $.fn.removeTag = function (value, options) {
        ...
        this.each(function () {
            ...
            var oldindex = $(this).attr("index").split(delimiter[id]);
            ...
            for (i = 0; i < old.length; i++) {
                if (old[i] != value) {
                    ...
                    indexstr = indexstr + delimiter[id] + oldindex[i];
                }
            }

            $.fn.tagsInput.importTags(this, str, indexstr, options);
    ...
    $.fn.tagsInput.updateTagsField = function (obj, tagslist, indexlist) {
        var id = $(obj).attr('id');
        $(obj).val(tagslist.join(delimiter[id]));
        $(obj).attr("index", indexlist.join(delimiter[id]));
    };

    $.fn.tagsInput.importTags = function (obj, val, indexstr, options) {
        $(obj).val('');
        var id = $(obj).attr('id');
        var tags = val.split(delimiter[id]);
        var index = indexstr.split(delimiter[id]);
        for (i = 0; i < tags.length; i++) {
            $(obj).addTag(tags[i], { focus: false, callback: false, index: index[i], close: options.close });
        }
        if (tags_callbacks[id] && tags_callbacks[id]['onChange']) {
            var f = tags_callbacks[id]['onChange'];
